...
templates_hitori = [
    ...
    "girl, {}",
    "anime girl, {}",
    "hair ornament, cube hair ornament, blue and yellow hair ornament, {}",
    "blue eyes, {}",
    "pink long hair, bangs, hair between eyes {}",
    "pink track jacket, {}",
    "cube hair ornament, blue eyes, pink long hair, pink track jacket, bangs, hair between eyes, {}",
]

templates_thatisit = [
    "a girl doing {}, girl",
    "a laughing girl doing {}",
    "a photo of {}",
    "a pose of {}",
    "in the pose of {}",
    "a girl in the pose of {}",
]
...
class TextualInversionDataset(Dataset):
    def __init__(
        ...
        if learnable_property == "hitori":
            self.templates = templates_hitori
        elif learnable_property == "thatisit":
            self.templates = templates_thatisit
        else:
            raise RuntimeError
...
def main():
    ...
    if args.resume_from_checkpoint:
        ...
        if path is None:
            ...
            # )  # TODO: fix mixtake jump step resuming checkpoint
            resume_step = 0
